    ...
    <div class="float-left">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item dropdown">
          <a class="dropdown-item" href="${pageContext.request.contextPath}/eventList">Events</a> 
      </li>
        </c:if>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="${pageContext.request.contextPath}/event">Add Event</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/eventList">Event List</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="${pageContext.request.contextPath}/bookingList">Booking List</a>
        </div>
      </li>
